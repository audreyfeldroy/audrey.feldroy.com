# AUTOGENERATED! DO NOT EDIT! File to edit: nbs/2025-01-30-This-Site-Is-Now-Powered-by-This-Notebook-Part-5.ipynb.

# %% auto 0
__all__ = ['app', 'rt', 'get_nb_paths', 'get_title_and_desc', 'get_date_from_iso8601_prefix', 'NBCard', 'mk_nbcard_from_nb_path',
           'index', 'StyledCode', 'MonsterHtmlRenderer', 'StyledMd', 'StyledCell', 'notebook', 'versions', 'wellknown']

# %% nbs/2025-01-30-This-Site-Is-Now-Powered-by-This-Notebook-Part-5.ipynb 3
...
# %% nbs/2025-01-30-This-Site-Is-Now-Powered-by-This-Notebook-Part-5.ipynb 6
app,rt = fast_app(pico=False)

# %% nbs/2025-01-30-This-Site-Is-Now-Powered-by-This-Notebook-Part-5.ipynb 10
def get_nb_paths(): 
    root = Path() if IN_NOTEBOOK else Path("nbs/")
    return L(root.glob("*.ipynb")).sorted(reverse=True)

# %% nbs/2025-01-30-This-Site-Is-Now-Powered-by-This-Notebook-Part-5.ipynb 12
...
# %% nbs/2025-01-30-This-Site-Is-Now-Powered-by-This-Notebook-Part-5.ipynb 14
...
# %% nbs/2025-01-30-This-Site-Is-Now-Powered-by-This-Notebook-Part-5.ipynb 18
...
# %% nbs/2025-01-30-This-Site-Is-Now-Powered-by-This-Notebook-Part-5.ipynb 19
...
# %% nbs/2025-01-30-This-Site-Is-Now-Powered-by-This-Notebook-Part-5.ipynb 21
@rt
def index():
...
# %% nbs/2025-01-30-This-Site-Is-Now-Powered-by-This-Notebook-Part-5.ipynb 23
...
# %% nbs/2025-01-30-This-Site-Is-Now-Powered-by-This-Notebook-Part-5.ipynb 24
...
# %% nbs/2025-01-30-This-Site-Is-Now-Powered-by-This-Notebook-Part-5.ipynb 25
def StyledMd(m):
    return Safe(markdown(m, MonsterHtmlRenderer))

# %% nbs/2025-01-30-This-Site-Is-Now-Powered-by-This-Notebook-Part-5.ipynb 26
def StyledCell(c):
...
# %% nbs/2025-01-30-This-Site-Is-Now-Powered-by-This-Notebook-Part-5.ipynb 28
@rt("/nbs/{name}")
...
# %% nbs/2025-01-30-This-Site-Is-Now-Powered-by-This-Notebook-Part-5.ipynb 30
@rt
def versions():
...
# %% nbs/2025-01-30-This-Site-Is-Now-Powered-by-This-Notebook-Part-5.ipynb 32
@rt('/.well-known/{fname}')
def wellknown(fname: str):
    fpath = f"../.well-known/{fname}" if IN_NOTEBOOK else f".well-known/{fname}"
    return Path(fpath).read_text()

# %% nbs/2025-01-30-This-Site-Is-Now-Powered-by-This-Notebook-Part-5.ipynb 34
serve()
